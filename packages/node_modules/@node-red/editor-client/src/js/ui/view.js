...
RED.view = (function() {
    ...
    function updateCanvasTextNode(d, nodeEl) {
        ...
        var bodyHeight = Math.max(1, d.h - 16);
        ...
        nodeEl.__canvasTextBodyObject__.style["pointer-events"] = "auto";
        ...
        nodeEl.__canvasTextBody__.style.overflow = "auto";
        ...
        nodeEl.__canvasTextBody__.style.pointerEvents = "auto";
        nodeEl.__canvasTextBody__.style.userSelect = "text";
        nodeEl.__canvasTextBody__.style.cursor = "text";
    }
    ...
    function _redraw() {
        ...
        if (forceFullRedraw || showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                ...
                canvasTextGroup.style["pointer-events"] = "auto";
                ...
                canvasTextBodyObject.style["pointer-events"] = "auto";
                ...
                canvasTextBody.addEventListener("wheel", function(evt) {
                    evt.stopPropagation();
                }, { passive: true });
