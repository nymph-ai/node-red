...
RED.view = (function() {
    ...
    function updateCanvasTextNode(d, nodeEl) {
        ...
        var titleHeight = 24;
        var lineHeight = 14;
        var bodyWidth = Math.max(1, d.w - (padding * 2));
        var bodyHeight = Math.max(1, d.h - titleHeight - padding);
        var maxChars = Math.max(8, Math.floor(bodyWidth / 7));
        var maxLines = Math.max(1, Math.floor(bodyHeight / lineHeight));
        var lines = wrapCanvasText(getCanvasTextValue(d), maxChars, maxLines);
        ...
        nodeEl.__canvasTextTitle__.setAttribute("x", padding);
        nodeEl.__canvasTextTitle__.setAttribute("y", 18);
        nodeEl.__canvasTextBody__.setAttribute("x", padding);
        nodeEl.__canvasTextBody__.setAttribute("y", titleHeight + 10);
    ...
    function _redraw() {
        ...
        if (forceFullRedraw || showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                ...
                canvasTextBody.setAttribute("font-family","Menlo, Consolas, monospace");
