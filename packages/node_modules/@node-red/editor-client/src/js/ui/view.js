...
RED.view = (function() {
    ...
    function updateCanvasTextNode(d, nodeEl) {
        ...
        nodeEl.__canvasTextTitle__.setAttribute("font-size", "14px");
        nodeEl.__canvasTextTitle__.setAttribute("font-weight", "normal");
        ...
        nodeEl.__canvasTextBody__.setAttribute("fill-opacity", hasValue ? "1" : "0.55");
        ...
        nodeEl.__canvasTextFooter__.setAttribute("fill-opacity", "0.62");
