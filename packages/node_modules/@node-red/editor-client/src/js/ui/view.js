...
RED.view = (function() {
    ...
    function updateCanvasTextNode(d, nodeEl) {
        ...
        nodeEl.__canvasTextBodyObject__.setAttribute("x", bodyX);
        nodeEl.__canvasTextBodyObject__.setAttribute("y", bodyY);
        nodeEl.__canvasTextBodyObject__.setAttribute("width", bodyWidth);
        nodeEl.__canvasTextBodyObject__.setAttribute("height", bodyHeight);
        nodeEl.__canvasTextBody__.textContent = textValue;
        nodeEl.__canvasTextBody__.style.width = bodyWidth + "px";
        nodeEl.__canvasTextBody__.style.height = bodyHeight + "px";
        nodeEl.__canvasTextBody__.style.boxSizing = "border-box";
        nodeEl.__canvasTextBody__.style.overflow = "hidden";
        nodeEl.__canvasTextBody__.style.whiteSpace = "pre-wrap";
        nodeEl.__canvasTextBody__.style.overflowWrap = "anywhere";
        nodeEl.__canvasTextBody__.style.fontFamily = "\"Helvetica Neue\", Arial, Helvetica, sans-serif";
        nodeEl.__canvasTextBody__.style.fontSize = "12px";
        nodeEl.__canvasTextBody__.style.fontWeight = "400";
        nodeEl.__canvasTextBody__.style.lineHeight = "1.35";
        nodeEl.__canvasTextBody__.style.color = hasValue ? "rgba(27, 27, 27, 0.82)" : "rgba(27, 27, 27, 0.5)";
        nodeEl.__canvasTextBody__.style.margin = "0";
        nodeEl.__canvasTextBody__.style.padding = "0";
        nodeEl.__canvasTextBody__.style.pointerEvents = "none";
    ...
    function _redraw() {
        ...
        if (forceFullRedraw || showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                ...
                var canvasTextBodyObject = document.createElementNS("http://www.w3.org/2000/svg","foreignObject");
                canvasTextBodyObject.setAttribute("class","red-ui-flow-node-canvas-text-body-object");
                canvasTextBodyObject.style.overflow = "hidden";
                canvasTextBodyObject.style["pointer-events"] = "none";
                canvasTextGroup.appendChild(canvasTextBodyObject);
                node[0][0].__canvasTextBodyObject__ = canvasTextBodyObject;

                var canvasTextBody = document.createElementNS("http://www.w3.org/1999/xhtml","div");
                canvasTextBody.setAttribute("class","red-ui-flow-node-canvas-text-body");
                canvasTextBodyObject.appendChild(canvasTextBody);
